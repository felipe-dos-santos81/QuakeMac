> Merged on 2026-09-01 from `docs/superpowers/specs/2026-08-30-mouse-only-control-design.md` (Part 1 below) and
> `docs/superpowers/plans/2026-08-30-mouse-only-control.md` (Part 2). Both parts are verbatim; internal
...
**Part 2 — implementation plan** (verbatim; formerly `docs/superpowers/plans/2026-08-30-mouse-only-control.md`)
