/*
in_sdl.c — SDL3 input module for GLQuake on macOS arm64.
Split out of gl_vidsdl.c: that file keeps the window/GL lifecycle,
this module owns the IN_* interface from input.h plus the SDL event
pump that feeds it. The bodies are verbatim moves from gl_vidsdl.c;
sdl_window stays owned there.
